mform - a form generation module for Kohana 3.0

Author: Emily Gillcoat
-----------------------------------------

mform removes the redundancy in creating labels with corresponding input fields all wrapped in a div. 
...
Examples
------------------------------------------
The mform code is above the code it generates. 
...
Form_Pair
This is created by mform in the view. Its methods are chainable.
...
mform
	...
	set_values($values)
		mform will hold the values until the correct form_pair is created
...
example_form is an example form with model, view and controller that shows how mform works.
